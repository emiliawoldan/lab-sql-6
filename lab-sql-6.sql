...
For 2020, the rental duration will be 3 days, with an offer price of 2.99€ and 
a replacement cost of 8.99€ (these are all fixed values for all movies for this year). 
...
LOAD DATA INFILE '/Users/emilia/Desktop/Iron_Hack/Labs/Unit_2/lab-sql-6/files_for_lab/films_2020.csv'
